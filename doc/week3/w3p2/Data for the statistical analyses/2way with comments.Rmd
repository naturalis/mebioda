...
---
Simulated phylogenies were generated with the software MESA, using trait-biased and heritable speciation probabilities. At a particular point of the simulation a user-specified fraction of terminal taxa were culled from the tree. Four mass extintion treatments we employed: 
