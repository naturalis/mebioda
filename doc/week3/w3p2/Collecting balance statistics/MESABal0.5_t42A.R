...
######GLOBALS#####
SEED_VECTOR = c(5000:4997,4995:4991,4989:4985)
...
NUMTREATS = 4  #this is the number of treatment types

TOLVAL = 0.005  #tolerance value for drop.tip()

EXT_STRENGTH_STR = '0.5'  #the strength of extinction, e.g. 0.9 = 90% extinction
...
for (seed in 1:SVSIZE[1])
{
  ...
  for (trt in 4:NUMTREATS)  #for each of the 4 treatment types
  {
