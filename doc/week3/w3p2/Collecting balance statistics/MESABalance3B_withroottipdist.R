...
#SEED_VECTOR = read.table("C:/R_MESADATA3/MESA_SEED_LIST.txt")
SEED_VECTOR = read.csv("SEEDNUMBER2.csv",header=F)

#SVSIZE = as.numeric(length(SEED_VECTOR))

SVSIZE = dim(SEED_VECTOR)[1]

#SEEDVEC2 = SEED_VECTOR[29:dim(SEED_VECTOR)[1],1]

#SVSIZE = length(SEEDVEC2)


#TIME_VECTOR = c(290,295,300,301,305,310,315,320,325,330,335,340,345,350,355,360,365,370,375,380,385,390,395,400,405,410,415,420,425,430,435,440,445,450,455,460,465,470,475,480,485,490,495,500,505,510,515,520,525,530,535,540,545,550,555,560,565,570,575,580,585,590,595,600)
...
EXT_STRENGTH_STR = '0.75'  #the strength of extinction, e.g. 0.9 = 90% extinction
...
{
  SEEDSTR = as.character(SEED_VECTOR[seed,1])
  #SEEDSTR = as.character(SEEDVEC2[seed])
  message(SEEDSTR)
  ...
  TARNAME2=paste('s',SEEDSTR, '_RAND',EXT_STRENGTH_STR,'.tar',sep='')
  ...
  #INTARNAMES = rbind(TARNAME2,TARNAME3,TARNAME4)
  ...
  #OUTFILENAMES = rbind(OUTFILENAME2,OUTFILENAME3,OUTFILENAME4)
