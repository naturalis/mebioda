...
setwd("C:/R_MESADATA/T_0.75")  #location of input and output files

######GLOBALS##### 
SEED_LIST = read.csv(file = "SEEDNUMBER2.csv", header = FALSE)
SEED_VECTOR = SEED_LIST[, 1]
...
NUMTREATS = 2  # this is the number of treatment types 
...
for (seed in 1:SVSIZE)
{
  ...
  OUTFILENAME1=paste('MESA_X5Balance_test_s',SEEDSTR,'_noext',EXT_STRENGTH_STR,'.out', sep="")
  OUTFILENAME2=paste('MESA_X5Balance_test_s',SEEDSTR,'_randext',EXT_STRENGTH_STR,'.out', sep="")
  OUTFILENAME3=paste('MESA_X5Balance_test_s',SEEDSTR,'_lotrtext',EXT_STRENGTH_STR,'.out', sep="")
  OUTFILENAME4=paste('MESA_X5Balance_test_s',SEEDSTR,'_hitrtext',EXT_STRENGTH_STR,'.out', sep="")
  OUTFILENAMES = rbind(OUTFILENAME1,OUTFILENAME2,OUTFILENAME3,OUTFILENAME4)
  
  for (trt in 2:NUMTREATS)  #for each of the 4 treatment types
  {
