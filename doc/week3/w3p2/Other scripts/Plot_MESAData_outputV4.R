...
RESULTS.MATRIX.CTRL = read.table("MESA_X5Balance_test_s4952_noext0.9.out")
RESULTS.MATRIX.RANDEXT = read.table("MESA_X5Balance_test_s4952_randext0.9.out")
RESULTS.MATRIX.LOTRTEXT = read.table("MESA_X5Balance_test_s4952_lotrtext0.9.out")
RESULTS.MATRIX.HITRTEXT = read.table("MESA_X5Balance_test_s4952_hitrtext0.9.out")
