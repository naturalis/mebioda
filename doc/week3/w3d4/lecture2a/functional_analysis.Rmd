...
Pairwise distance in "trait space"
----------------------------------
...
Let's read these data and compute the Gower distance between the species.
...
Likewise, here are the abundances for the species (file [here](abundances.tsv)):
